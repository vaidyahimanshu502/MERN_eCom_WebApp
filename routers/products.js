...
//delete product
router.delete("/delete-product/:pid", checkAuthentication, isAdmin, deleteProduct);

// update product
router.put("/update-product/:id", checkAuthentication, isAdmin, formidable(), updataProduct);
